...
-->
        ...
        <div class="row">
          <div class="offset-1 col-10">
            <div class="form-group">
              <div class="input-group">
                <input type="text" class="form-control" id="reservationDate" name="reservationDate" required/>
              </div>
            </div>
          </div>
        </div><br/><br/>
        <?php
          ...
          $result = $cn->query($sql);
            if ($result->num_rows > 0) {
              ...
              while($row = $result->fetch_assoc()) {
                echo '
                  <div class="offset-1 col-10"><label class="checkbox-inline"><input type="checkbox" name="amenity[]" value="' . $row["id"] . '">&nbsp;' . $row["amenityName"] . '</label></div>
                ';
                }
                echo '</div><br/><br/>';
              }
